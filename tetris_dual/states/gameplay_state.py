...
class GameplayState(GameState):
    ...
    def on_draw(self, window):
        ...
        if self.board1.game_over:
            arcade.draw_text("GAME OVER", x_left+board_w//2, y_board+board_h+15,
                             (255,100,100), 16, anchor_x="center")
        if self.board2.game_over:
            arcade.draw_text("GAME OVER", x_right+board_w//2, y_board+board_h+15,
                             (255,100,100), 16, anchor_x="center")
    ...
    def on_key_press(self, key, modifiers):
        ...
        if key in (arcade.key.SPACE, arcade.key.ESCAPE):
            from .menu_pause_settings import PauseState
